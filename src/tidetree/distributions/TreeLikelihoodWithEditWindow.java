            ...
            if (update1 != Tree.IS_CLEAN || update2 != Tree.IS_CLEAN) {
                ...
                if (m_siteModel.integrateAcrossCategories()) {
                    ...
                    if (parentBeforeChildrenAfterEditHeight | parentBeforeChildrenAfterEditStop) {
                        ...
                        likelihoodCore.calculatePartials(child1, child2, node, substitutionModel.getDropoutProbability(), substitutionModel.getUnobservedIndex());
                    }
                } else {
                    ...
                    if (useOrigin){
                        ...
                        if (m_siteModel.integrateAcrossCategories()) {
                            ...
                            if (parentBeforeChildrenAfterEditHeight | parentBeforeChildrenAfterEditStop) {
                                ...
                                likelihoodCore.calculatePartials(node, originNode, substitutionModel.getDropoutProbability(), substitutionModel.getUnobservedIndex());
                            }
                        }
                        //node = rootNode;
